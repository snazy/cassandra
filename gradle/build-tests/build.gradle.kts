...
tasks.register<Test>("testGradleBuild") {
    ...
    inputs.file(rootProject.file("buildSrc/build.gradle.kts"))
    inputs.file(rootProject.file("buildSrc/settings.gradle.kts"))
    inputs.files(rootProject.file("buildSrc/src"))
