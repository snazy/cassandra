...
public abstract class CQLTester
{
    ...
    private static final Map<Pair<User, ProtocolVersion>, Session> sessions = new ConcurrentHashMap<>();
    ...
    private static Cluster.Builder clusterBuilder(ProtocolVersion version)
    {
