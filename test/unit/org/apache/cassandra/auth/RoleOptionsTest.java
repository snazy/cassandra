...
public class RoleOptionsTest
{
    ...
    public void validateValueTypes()
    {
        ...
        assertInvalidOptions(opts, "Invalid hashed password value");
    ...
    private void setupRoleManager(IRoleManager manager)
    {
        ...
        AuthManager authManager = new AuthManager(manager, new AllowAllAuthorizer(), new AllowAllNetworkAuthorizer());
