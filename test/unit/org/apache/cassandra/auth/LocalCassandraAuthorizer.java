...
class LocalCassandraAuthorizer extends CassandraAuthorizer
{
    @Override
    ResultMessage.Rows select(SelectStatement statement, QueryOptions options)
    {
        return statement.executeInternal(QueryState.forInternalCalls(), options, FBUtilities.nowInSeconds(), System.nanoTime());
    }
