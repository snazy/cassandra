...
plugins {
    ...
    id("org.caffinitas.gradle.antlr") version "0.1.1"
...
dependencies {
    ...
    implementation("com.datastax.cassandra:cassandra-driver-core:3.9.0:shaded") {
    ...
    testImplementation("org.apache.cassandra:dtest-api:0.0.4")
...
microbench {
    ...
    if (JavaVersion.current().isJava11Compatible)
        jvmOptions.set(testRunner.java11Args +
                listOf("-javaagent:${project.configurations.getByName("jamm").singleFile}"))
}
        ...
        withGroovyBuilder {
            "settings" {
                ...
                runConfigurations.defaults(Application::class.java) {
                    ...
                    moduleName = "apache-cassandra.main"
                }
