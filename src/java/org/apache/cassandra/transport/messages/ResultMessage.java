...
import static org.apache.cassandra.cql3.ResultSet.ResultMetadata.computeResultMetadataId;
...
public abstract class ResultMessage extends Message.Response
{
    ...
    public static class Prepared extends ResultMessage
    {
        ...
        {
            this(statementId, resultMetadataId, ResultSet.PreparedMetadata.fromPrepared(prepared), ResultSet.ResultMetadata.fromPrepared(prepared));
        }

        /**
         * Used when deserializing
         */
        private Prepared(MD5Digest statementId, MD5Digest resultMetadataId, ResultSet.PreparedMetadata metadata, ResultSet.ResultMetadata resultMetadata)
        {
            super(Kind.PREPARED);
