    ...
    public void printColumnFamilyStats(PrintStream outs, boolean ignoreMode, String [] filterList)
    {
        ...
        for (Entry<String, List<ColumnFamilyStoreMBean>> entry : cfstoreMap.entrySet())
        {
            ...
            for (ColumnFamilyStoreMBean cfstore : columnFamilies)
            {
                ...
                outs.printf("\t\tAverage, max live cells per slice (last five minutes): %f , %f%n", cfstore.getLiveCellsPerSlice(), cfstore.getLiveCellsPerSliceMax());
                outs.printf("\t\tAverage, max tombstones per slice (last five minutes): %f , %f%n", cfstore.getTombstonesPerSlice(), cfstore.getTombstonesPerSliceMax());
