...
public class CustomPayloadMirroringQueryHandler implements QueryHandler
{
    ...
    public ResultMessage.Prepared prepare(String query, QueryState queryState, Map<String, ByteBuffer> customPayload)
    {
        ResultMessage.Prepared prepared = queryProcessor.prepare(query, queryState, customPayload);
